  ...
  Timer {
    ...
    onTriggered: {
      ...
      case 5:
        ...
        app.inferenceModels=[{id:"test/model",name:"Test model",context_length:32000,reasoning:{supported_efforts:["high","low"]}}]
      ...
      case 7:
        ...
        break
      case 8:
        check(app.reasoningEffort==="low" && app.environment==="environment.toml","setup recovery lost effort or environment")
